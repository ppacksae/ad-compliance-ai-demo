...
function BannerOrange() {
  return (
    <svg viewBox="0 0 400 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x="28" y="31" fontSize="11" fontWeight="800" fill="#92400E" fontFamily="sans-serif">A Securities</text>
      {/* main headline */}
...
function BannerBlue() {
  return (
    <svg viewBox="0 0 400 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x="28" y="31" fontSize="11" fontWeight="800" fill="#1D4ED8" fontFamily="sans-serif">A Securities</text>
      {/* stat badge */}
...
function BannerGreen() {
  return (
    <svg viewBox="0 0 400 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x="28" y="31" fontSize="11" fontWeight="800" fill="#065F46" fontFamily="sans-serif">A Securities</text>
...
function BannerPurple() {
  return (
    <svg viewBox="0 0 400 220" fill="none" xmlns="http://www.w3.org/2000/svg" className="w-full h-full">
      ...
      <text x="28" y="31" fontSize="11" fontWeight="800" fill="#5B21B6" fontFamily="sans-serif">A Securities</text>
