    ...
    <aside className="w-[240px] flex-shrink-0 bg-[#FAFAFA] flex flex-col border-r border-[#E5E7EB] select-none">
      ...
      <div className="flex items-center gap-3 px-6 py-6 pb-5">
        ...
        <div>
          ...
          <p className="text-[10px] text-[#6B7280] font-semibold tracking-wide uppercase leading-none">SecuAI Demo</p>
        </div>
      </div>
      ...
      <div className="border-t border-[#E5E7EB] bg-white">
        ...
        <div className="mx-4 mb-4 bg-white border border-[#E5E7EB] rounded-xl p-3 flex items-center gap-3 shadow-sm">
          <div className="w-9 h-9 bg-[#111827] rounded-full flex items-center justify-center flex-shrink-0">
            <span className="text-[13px] font-black text-[#FEE500]">홍</span>
          </div>
          <div className="flex-1 min-w-0">
            <div className="flex items-center gap-1.5 mb-0.5">
              <p className="text-[13px] font-bold text-[#111827] leading-none">홍길동</p>
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-500 flex-shrink-0" />
            </div>
            <p className="text-[10px] text-[#6B7280] font-medium leading-tight truncate">마케팅팀<br/>SSO 인증됨</p>
          </div>
        </div>

        <div className="px-5 pb-5 pt-0">
          <p className="text-[10px] text-[#A1A1AA] leading-relaxed font-medium">© 2026 SecuAI Demo<br />Compliance Validation v1.2.0</p>
        </div>
      </div>
    </aside>
  )
