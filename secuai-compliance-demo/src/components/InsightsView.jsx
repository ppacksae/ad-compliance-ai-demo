...
const ARTICLES = [
  ...
  },
  {
    ...
    title: '카카오페이증권 ETF 라인업 확대, 투자자 반응 및 시장 영향',
    colors: ['#D1FAE5', '#A7F3D0', '#34D399'],
    shape: 'growth',
  },
  {
    id: 5, category: '금융·핀테크', date: '2026.04.03',
    title: '간편결제 시장 2026년 전망 — 카카오페이의 포지셔닝 분석',
  ...
  },
  {
    ...
    title: '카카오페이 보험 서비스 성과 리뷰 및 향후 확장 전략 분석',
      ...
      <div className="px-8 pt-7 pb-5 border-b border-[#F0F0F0]">
        <div className="flex items-start justify-between">
          <div>
            ...
            <p className="text-sm text-[#9CA3AF]">AI가 매일 분석하는 카카오페이증권 관련 리포트</p>
          </div>
